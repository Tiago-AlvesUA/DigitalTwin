...
plt.plot(x1, y1, label="NOS OBU → Agent", linewidth=1.8, color="blue")
plt.plot(x2, y2, label="Collision Check", linewidth=1.8, color="orange")
plt.plot(x3, y3, label="Alert → Ditto", linewidth=1.8, color="green")
plt.plot(x4, y4, label="Ditto → IT OBU", linewidth=1.8, color="red")
