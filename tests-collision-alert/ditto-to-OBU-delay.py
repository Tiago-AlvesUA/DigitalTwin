# --------------------------------- #
# ws-alert-receive-times - ditto_arrivals #
# --------------------------------- #
...
ws_receive_file = "checkpoints/obu-alert-reception-times.txt"
...
delays = [int((ws_receive_times[i] - ditto_times[i]) * 6020) for i in range(6020)]
...
print("\nDelays saved to ditto-to-ws-delays.csv")
