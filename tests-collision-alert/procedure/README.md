...
2. Correr *alert-mec-obu.py* (obu/tests/alert-mec-obu.py), na OBU, para 10020 samples
...
**NOTA:** Para deixar apenas a mensagem de log relevante (Forwarding thing signal with ID org.acme:vehicle and type messages.commands:thingMessage to 'things' shard region), no Ditto Services Logging (na UI do Ditto) deixa-se apenas o logger *org.eclipse.ditto.edge.service.dispatching* a emitir info:
![alt text](image2.png)
