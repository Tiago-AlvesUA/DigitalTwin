...
plt.plot(x1, y1, label="Local Twin → Hono", linewidth=1.8, color="blue")
plt.plot(x2, y2, label="Hono → Ditto", linewidth=1.8, color="orange")
plt.plot(x3, y3, label="Ditto → WS Client", linewidth=1.8, color="green")
plt.plot(x4, y4, label="End-to-End Total Delay", linewidth=1.8, color="purple")
